...
if __name__ == '__main__':
    ...
    evaluator = CAPTURE()
    #object_precision, object_recall, object_f1, attribute_precision, attribute_recall, attribute_f1 = evaluator.compute_score(refs, preds, prev_gt_parsed=prev_gt_parsed, prev_cand_parsed=prev_cand_parsed, extra_objects=extra_objects, extra_attributes=extra_attributes)
