...
from .processors.pairwise import preprocess_pairwise_dataset, print_pairwise_dataset_example, preprocess_sc_dataset, preprocess_sc_dataset_all
...
def get_preprocess_and_print_func(
    ...
    stage: Literal["pt", "sft", "rm", "ppo", "kto", "sc"],
    template: "Template",
